...
namespace ODataWebV4.OData
{
    ...
    public class ODataService : DSPDataService<DSPContext>
    {
        ...
        private static void CreateDefaultMetadata()
        {
            ...
            _metadata.AddPrimitiveProperty(product, "ReleaseDate", typeof(DateTimeOffset));
            _metadata.AddPrimitiveProperty(product, "DiscontinuedDate", typeof(DateTimeOffset?));
            ...
            _metadata.AddPrimitiveProperty(advertisement, "AirDate", typeof(DateTimeOffset));
            #endregion
            ...
            _metadata.AddPrimitiveProperty(employee, "HireDate", typeof(DateTimeOffset));
        ...
        protected static DSPContext CreateDefaultData(DSPMetadata metadata)
        {
            ...
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                0, "Bread", "Whole grain bread", new DateTimeOffset(new DateTime(1992, 1, 1)), null, (Int16)4, 2.5, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                1, "Milk", "Low fat milk", new DateTimeOffset(new DateTime(1995, 10, 1)), null, (Int16)3, 3.5, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                2, "Vint soda", "Americana Variety - Mix of 6 flavors", new DateTimeOffset(new DateTime(2000, 10, 1)), null, (Int16)3, 20.9, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                3, "Havina Cola", "The Original Key Lime Cola", new DateTimeOffset(new DateTime(2005, 10, 1)), new DateTimeOffset(new DateTime(2006, 10, 1)), (Int16)3, 19.9, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                4, "Fruit Punch", "Mango flavor, 8.3 Ounce Cans (Pack of 24)", new DateTimeOffset(new DateTime(2003, 1, 5)), null, (Int16)3, 22.99, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                5, "Cranberry Juice", "16-Ounce Plastic Bottles (Pack of 12)", new DateTimeOffset(new DateTime(2006, 8, 4)), null, (Int16)3, 22.8, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                6, "Pink Lemonade", "36 Ounce Cans (Pack of 3)", new DateTimeOffset(new DateTime(2006, 11, 5)), null, (Int16)3, 18.8, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                7, "DVD Player", "1080P Upconversion DVD Player", new DateTimeOffset(new DateTime(2006, 11, 15)), null, (Int16)5, 35.88, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(productsSet.ResourceType, productPropertyList,
                8, "LCD HDTV", "42 inch 1080p LCD with Built-in Blu-ray Disc Player", new DateTimeOffset(new DateTime(2008, 5, 8)), null, (Int16)3, 1088.8, null, new List<DSPResource>(), null));
            ...
            products.Add(CreateResourceObject(featuredProductType, featuredProductPropertyList,
                9, "Lemonade", "Classic, refreshing lemonade (Single bottle)", new DateTimeOffset(new DateTime(1970, 1, 1)), null, (Int16)7, 1.01, null, new List<DSPResource>(), null));
            products.Add(CreateResourceObject(featuredProductType, featuredProductPropertyList,
                10, "Coffee", "Bulk size can of instant coffee", new DateTimeOffset(new DateTime(1982, 12, 31)), null, (Int16)1, 6.99, null, new List<DSPResource>(), null));
            ...
            advertisements.Add(CreateResourceObject(advertisementSet.ResourceType, advertisementPropertyList,
                new Guid("F89DEE73-AF9F-4CD4-B330-DB93C25FF3C7"), "Old School Lemonade Store, Retro Style", new DateTimeOffset(new DateTime(2012, 11, 7))));
            advertisements.Add(CreateResourceObject(advertisementSet.ResourceType, advertisementPropertyList,
                new Guid("DB2D2186-1C29-4D1E-88EF-A127F521B9C6"), "Early morning start, need coffee", new DateTimeOffset(new DateTime(2000, 02, 29))));
            ...
            persons.Add(CreateResourceObject(employeeType, employeePropertyList, 5, "Jaime Yorres", null, 10001L, new DateTimeOffset(new DateTime(2000, 5, 30)), 15000.0f));
            persons.Add(CreateResourceObject(employeeType, employeePropertyList, 6, "Fran Wilson", null, 10002L, new DateTimeOffset(new DateTime(2001, 1, 2)), 12000.0f));
        ...
        public static void InitializeService(DataServiceConfiguration config)
        {
            ...
            config.AnnotationsBuilder = (model) =>
            {
                ...
                myModel.AddVocabularyAnnotation(new EdmAnnotation(container, new EdmTerm("Org.OData.Display.V1", "Description", EdmPrimitiveTypeKind.String), new EdmStringConstant("This is a sample OData service with vocabularies")));

                //Annotate Product Entity with Display.Description vocabulary
                var product = (IEdmEntityType)model.FindType("ODataDemo.Product");
                myModel.AddVocabularyAnnotation(new EdmAnnotation(product, new EdmTerm("Org.OData.Display.V1", "Description", EdmPrimitiveTypeKind.String), new EdmStringConstant("All Products available in the online store")));

                //Annotate Product.Name property with Display.DisplayName vocabulary
                var name = product.FindProperty("Name");
                myModel.AddVocabularyAnnotation(new EdmAnnotation(name, new EdmTerm("Org.OData.Display.V1", "DisplayName", EdmPrimitiveTypeKind.String), new EdmStringConstant("Product Name")));

                //Annotate Supplier EntitySet with Publish vocabulary
                var supplierSet = container.FindEntitySet("Suppliers");
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "PublisherName", EdmPrimitiveTypeKind.String), new EdmStringConstant("Microsoft Corp.")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "PublisherId", EdmPrimitiveTypeKind.String), new EdmStringConstant("MSFT")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "Keywords", EdmPrimitiveTypeKind.String), new EdmStringConstant("Inventory, Supplier, Advertisers, Sales, Finance")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "AttributionUrl", EdmPrimitiveTypeKind.String), new EdmStringConstant("http://www.odata.org/")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "AttributionDescription", EdmPrimitiveTypeKind.String), new EdmStringConstant("All rights reserved")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "DocumentationUrl ", EdmPrimitiveTypeKind.String), new EdmStringConstant("http://www.odata.org/")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "TermsOfUseUrl", EdmPrimitiveTypeKind.String), new EdmStringConstant("All rights reserved")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "PrivacyPolicyUrl", EdmPrimitiveTypeKind.String), new EdmStringConstant("http://www.odata.org/")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "LastModified", EdmPrimitiveTypeKind.String), new EdmStringConstant("4/2/2013")));
                myModel.AddVocabularyAnnotation(new EdmAnnotation(supplierSet, new EdmTerm("Org.OData.Publication.V1", "ImageUrl ", EdmPrimitiveTypeKind.String), new EdmStringConstant("http://www.odata.org/")));
        ...
        public ODataService()
        {
            ...
            if (HttpContext.Current != null && HttpContext.Current.Session != null && applications.Contains(applicationPath))
            {
                String sessionID = HttpContext.Current.Session.SessionID;
                if (!String.Equals(sessionID, ODataWebSessionIdManager.ODataReadOnlySession,StringComparison.InvariantCultureIgnoreCase))
                {
                    if (WebOperationContext.Current.IncomingRequest.UriTemplateMatch != null)
                    {
                        ...
                        if (serviceUri == null)
                        {
                            ...
                            Debug.Assert(serviceUriBuilder.Path.StartsWith(applicationPath), "Expected the service URI to start with '/V4'.");
                            serviceUriBuilder.Path = applicationPath + "/(S(" + sessionID + "))" +
                                                     serviceUriBuilder.Path.Substring(applicationPath.Length);
                        ...
                        if (serviceUri != null)
                        {
                            ...
                            Debug.Assert(requestUriBuilder.Path.StartsWith(applicationPath), "Expected the service URI to start with '/V4'.");
                            requestUriBuilder.Path = applicationPath + "/(S(" + sessionID + "))" +
                                                     requestUriBuilder.Path.Substring(applicationPath.Length);
