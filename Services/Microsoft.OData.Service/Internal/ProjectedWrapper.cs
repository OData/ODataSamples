...
namespace Microsoft.OData.Service.Internal
{
    ...
    public abstract class ProjectedWrapper : IProjectedResult
    {
        ...
        private static readonly Type[] precreatedProjectedWrapperTypes = new Type[]
        {
        ...
        private static readonly string[] projectedPropertyNames = new string[]
        {
            "ProjectedProperty0",
            "ProjectedProperty1",
            "ProjectedProperty2",
        ...
        /// <summary>Gets the full name of the <see cref="T:Microsoft.OData.Service.Providers.ResourceType" /> that represents the type of this result.</summary>
        ...
        public string ResourceTypeName
        {
            ...
            set
            {
                // Note: checking for null here resulted in that some providers may collapse empty-string
                // to null and will try to set null to this property on ProjectedWrapperMany.Next.
        ...
        {
            return projectedPropertyCount < precreatedProjectedWrapperTypes.Length ? precreatedProjectedWrapperTypes[projectedPropertyCount] : typeof(ProjectedWrapperMany);
        }
        ...
        internal static object ProcessResultEnumeration(object resource)
        {
            ...
            return WebUtil.IsElementIEnumerable(resource, out enumerable) ? new EnumerableWrapper(enumerable) : resource;
        }
        ...
        internal static object ProcessResultInstance(object resource)
        {
            ...
            return projectedWrapper != null && string.IsNullOrEmpty(projectedWrapper.resourceTypeName) ? null : resource;
        }
    ...
    public class ProjectedWrapperMany : ProjectedWrapper
    {
        ...
        /// <summary>Gets or sets another instance of <see cref="T:Microsoft.OData.Service.Internal.ProjectedWrapperMany" /> which contains the set of the next eight projected properties, and possibly another link.</summary>
