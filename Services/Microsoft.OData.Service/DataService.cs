...
#pragma warning restore 0169, 0649
        ...
        /// This method will be called when the class derived from <see cref="DataService&lt;T&gt;"/> does implement IServiceProvider,
        /// and <typeparamref name="T"/> does not implement metadataPovider and queryProvider.
        ...
        /// </returns>
        protected virtual IDataServiceInternalProvider CreateInternalProvider(object dataSourceInstance)
        {
            ...
            {
                return new EntityFrameworkDataServiceProvider(this, dataSourceInstance);
            }
            else
            {
                return new ReflectionDataServiceProvider(this, dataSourceInstance);
            }
        }
        ...
        private static void ValidateSingleResultValue(object singleResult, SegmentInfo segmentInfo, DataServiceProviderWrapper provider)
        {
            ...
            if (segmentInfo.TargetKind == RequestTargetKind.OpenProperty && singleResult != null)
            {
                ...
                resourceType = WebUtil.GetResourceType(provider, singleResult);
                WebUtil.CheckResourceNotCollectionForOpenProperty(resourceType, segmentInfo.Identifier);
            }
        }
            ...
            out bool isInternallyCreatedProvider)
        {
            ...
            else
            {
                ...
                {
                    IDataServiceInternalProvider internalProvider = this.CreateInternalProvider(dataSourceInstance);

                    // Note the fact that the provider was created internally.
                    isInternallyCreatedProvider = true;
                    metadataProviderInstance = (IDataServiceMetadataProvider)internalProvider;
                    queryProviderInstance = (IDataServiceQueryProvider)internalProvider;
                }
            }
        }
