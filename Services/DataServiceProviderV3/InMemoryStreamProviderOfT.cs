...
namespace DataServiceProviderV3
{
        ...
        where TComparer : IEqualityComparer<object>, new()
    {
        ...
        public Func<DataServiceOperationContext, string> GetContentTypeForNewStreamFunc
        {
            ...
            set
            {
                Debug.Assert(value != null, "Null values not allowed");
        ...
        {
            Debug.Assert(entity != null, "Null entity argument");
        ...
        {
            Debug.Assert(entity != null, "Null entity argument");
            Debug.Assert(streamProperty != null, "Null streamProperty argument");
            this.CheckOperationContext(operationContext);
        ...
        {
            Debug.Assert(entitySetName != null, "Null entitySetName argument");
            this.CheckOperationContext(operationContext);
        ...
        private void CheckOperationContext(DataServiceOperationContext operationContext)
        {
            ...
            {
                Debug.Assert(operationContext != null, "Null operationContext argument");
            }
        }
        ...
        internal class StreamWrapperNameEqualityComparer : EqualityComparer<StreamWrapper>
        {
            ...
            {
                Debug.Assert(x != null, "Null x argument");
                Debug.Assert(y != null, "Null y argument");
            ...
            {
                Debug.Assert(obj != null, "Null obj argument");
                if (obj.Name == null)
                {
                    return 0;
                }
