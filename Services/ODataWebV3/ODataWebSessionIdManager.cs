...
namespace ODataWebV3
{
    ...
    public class ODataWebSessionIdManager : ISessionIDManager
    {
        ...
        private bool IsNorthwindServiceFilePath(string filePath)
        {
            ...
            if (applicationPath == "/")
            {
                return string.Equals(filePath, northwindFilePath, StringComparison.InvariantCultureIgnoreCase);
            }
            return string.Equals(filePath, string.Concat(applicationPath, northwindFilePath), StringComparison.InvariantCultureIgnoreCase);
        }
        ...
        private bool IsODataServiceFilePath(string filePath)
        {
            ...
            if (applicationPath == "/")
            {
                return string.Equals(filePath, oDataFilePath, StringComparison.InvariantCultureIgnoreCase);
            }
            return string.Equals(filePath, string.Concat(applicationPath, oDataFilePath), StringComparison.InvariantCultureIgnoreCase);
        }
    }
}
