...
namespace ODataEtagSample
{
    class Program
    {
        private static readonly string serverUrl = "http://localhost:5245";
        ...
        private static void Configuration(IAppBuilder builder)
        {
            ...
            configuration.
                MapODataServiceRoute(
                    ...
                    routingConventions: ODataRoutingConventions.CreateDefaultWithAttributeRouting("odata", configuration),
